...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  resolve: {
    alias: {
      'c-ui-lib': path.resolve(__dirname, '../dist/c-ui.js'),
      'c-ui-style': 'stylesheet/css/c-ui.css',
      'c-ui-locale-zh': path.resolve(__dirname, '../dist/locale/zh-CN.js'),
      'c-ui-locale-en': path.resolve(__dirname, '../dist/locale/en-US.js')
    }
  },
  plugins: [
