  ...
  <div
    ...
    :class="[
      ...
      status ? `at-input-${status}` : '',
      {
        ...
        'at-input--prepend': $slots.append,
        'at-input--icon': icon
      }
    ]">
    <!-- S prepend element -->
    <div class="at-input-group__prepend" :class="{ '
    at-input-group--button': prependButton }" v-if="$slots.
    prepend">
    ...
    <!-- S icon -->
    <i class="at-input__icon icon" :class="iconClass"
    v-if="icon"></i>
    <!-- E icon -->

    <!-- S append element -->
    <div class="at-input-group_append" :class="{ '
    at-input-group--button': appendButton }" v-if="$slots.append">
