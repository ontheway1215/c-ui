<template>
  <div>
    <transition name="fade">
      <div class="at-modal__mask" v-show="visible" @click="handleMaskClick">
      </div>
    </transition>
    <!-- mask -->
    <div
        ...
        <div class="at-modal" :style="modalStyle" v-show="visible">
          ...
          <div class="at-modal__body">
            <slot>
              ...
              <div class="at-modal__input" v-if="showInput">
                <at-input v-model="inputValue" :placeholder="inputPlaceholder"
                @keyup.enter.native="handleAction('confirm')" ref="input"></at-input>
              </div>
            </slot>
          </div>
          <div class="at-modal__footer" v-if="showFooter">
            <slot name="footer">
              ...
              <at-button type="primary" v-show="showConfirmButton"
...
export default {
  ...
  computed: {
    ...
    localeOKText () {
      return (typeof this.okText === 'undefined') ? t('at.modal.okText') :
      this.okText
    },
    localeCancelText () {
      return (typeof this.cancelText === 'undefined') ? t('at.modal.cancelText') :
      this.cancelText
    }
  },
  watch: {
